<?php
$menu_class = \MYTHEME_THEME\Inc\Menus::get_instance();
                ...
                <ul class="navbar-nav mr-auto">
                    <?php foreach ($header_menus as $menu_item) {
                        if(!$menu_item->menu_item_parent) {
                            $child_menus = $menu_class->get_child_menus($header_menus, $menu_item->ID);
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <?php foreach ($child_menus as $child) { ?>
                                            <a class="dropdown-item" href="<?php echo esc_html($child->url) ?>">
